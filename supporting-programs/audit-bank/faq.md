...
Projects funded through the Stellar Community Fund involving financial protocols, high-dependency data services, or high-traction dApps. See details [here](official-rules.md#participant-eligibility).
...
The [Audit Readiness Checklist](audit-readiness-checklist.md), including [STRIDE threat model framework](https://developers.stellar.org/docs/build/security-docs), are available to support your audit readiness.
