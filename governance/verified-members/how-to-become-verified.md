...
| Opportunities                                 | Vote actively for projects to allocate SCF Build Awards (Open Track), and be considered for invitation to virtual and IRL events. | Everything of Navigator, plus the ability to become a Quarterly Delegate, and be included in Pilot-only conversations on key strategy topics, and propose, contribute and vote for governance proposals. |
