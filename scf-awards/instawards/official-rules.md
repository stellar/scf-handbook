...
* [x] Are actively participating in a local [Stellar Ambassador Chapter](https://stellar.gitbook.io/ambassador-program)
* [x] Are building (or preparing to build) on Stellar
* [x] Have a clearly defined, achievable short-term scope of work
* [x] Are seeking early execution support rather than long-term funding

In addition, Applicants shall satisfy all relevant requirements, including eligibility criteria in the [SCF Official Rules for Submissions](../official-rules-for-submissions.md).
