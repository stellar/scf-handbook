...
{% hint style="info" %}
Before engaging in Discord, make sure to read the [SCF Discord Rules & Guidelines](../../additional-support/navigating-discord/) and if you're new to Discord, check out this [beginner's guide](https://support.discord.com/hc/en-us/articles/360045138571-Beginner-s-Guide-to-Discord).
{% endhint %}
...
Often, it's not enough to just post a lot about your project and add “I welcome feedback” at the end. Instead, be specific and identify questions you want answers to that can improve your project!

#### 👓  |  Tag the right audience

Tag the group of people who are likely able to answer your question. We've recently added the ability for verified members to indicate what kind of support they can give. Learn more about [who to tag for what here](../../additional-support/navigating-discord/).
